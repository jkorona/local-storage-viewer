// Generated on 2015-08-24 using generator-chrome-extension 0.3.1
'use strict';
      ...
      dist: {
        options: {
          archive: function() {
            ...
            return 'package/Open In New Tab for LocalStorage-' + manifest.version + '.zip';
          }
        },
        files: [{
          expand: true,
